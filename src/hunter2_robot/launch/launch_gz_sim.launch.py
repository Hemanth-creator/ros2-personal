...
def generate_launch_description():
    ...
    hunter_description_path = os.path.join(
        get_package_share_directory('hunter2_robot'))
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare("hunter2_robot"), "hunter2_description", "urdf",'hunter2_base_gazebo.xacro']
            ),
            " ",
            "sim_gazebo:=sim",
        ]
    ...
    load_ackermann_controller = Node(
        ...
        arguments=['ackermann_steering_controller',
                   ...
                   PathJoinSubstitution(
                    [
                        FindPackageShare('hunter2_robot'),
                        'config',
